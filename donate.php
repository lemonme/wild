...
<head>
	<meta charset="UTF-8">
	<title>Wild Role Play - Донат</title>
		...
		<div class="container">
			<div>
				<div class="DonateWindow">
					...
					<div class="Form">
						<div class="select">
							<select name="" id="Select">
								...
								<option value="1">Wild Role Play #1</option>
					...
					<p id="confirm">Нажимая кнопку "Перейти к оплате" Вы соглашаетесь с условиями пожертвования и договором оферты</p>
				</div>
				<div id="Cortez"></div>
			</div>
		</div>
