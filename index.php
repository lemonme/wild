<!--====================
	Разработчик John Unity (Lemon Group) - vk.com/johnunity
	Группа разработчика - vk.com/l__emon
	Дизайнер John Unity - vk.com/johnunity
	Группа дизайнера - vk.com/l__emon
	Для Wild RP
=====================-->
<!DOCTYPE html>
<html lang="ru">
...
<body>
	<header>
		...
		<div class="container">
			...
			<p id="HeadP">Управляйте городом, ведите бизнес,<br> или создайте свой криминальный империум на <span style="color: orange;">Wild Role Play</span></p>
			<nav class="BtnMenu">
				<ul class="BtnMenuUL">
					<li>
						<a href="">
	...
	<section class="WhyUnusual">
		<div class="container">
			<h2 class="TitleH2">Почему именно Wild Role Play?</h2>
			<div class="WhyUnusualBlock">
				<div class="WhyUnusualSubblock wow rotateInDownLeft" data-wow-duration="0.5s" data-wow-delay="0.5s" data-wow-offset="120">
					...
					<p class="">Стань кем угодно, от мирного гражданина<br> до опасной мафиози</p>
				</div>
				<div class="WhyUnusualSubblock wow rotateInDownLeft" data-wow-duration="0.5s" data-wow-delay="1s" data-wow-offset="120">
					...
					<p class="">Наш мир Криминальной России Мультиплеер богат событиями,<br> миссиями и возможностями для вас и ваших друзей</p>
				</div>
				<div class="WhyUnusualSubblock wow rotateInDownLeft" data-wow-duration="0.5s" data-wow-delay="1.5s" data-wow-offset="120">
					...
					<p class="">Наши администраторы всегда поддержат вас</p>
				</div>
